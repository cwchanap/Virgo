...
struct NotationLayoutEngineTests {
    ...
    func renderContractsExposeSemanticAccessibilityLabels() throws {
        ...
        let layout = support.legacyPrepare(notes: [
    ...
    func minimumMeasureCountPreservesTrailingEmptyMeasures() {
        let layout = support.legacyPrepare(
    ...
    func consecutiveSixteenthsCreateTwoBeamLevels() throws {
        ...
        let layout = support.legacyPrepare(notes: notes, style: style).layout
    ...
    func measureWrappingToNewRowGetsSeparateStartBarline() {
        ...
        let layout = support.legacyPrepare(notes: notes, minimumMeasureCount: 20).layout
    ...
    func shuffledInputIsDeterministic() {
        ...
        let forward = support.legacyPrepare(notes: notes).layout
        let reversed = support.legacyPrepare(notes: Array(notes.reversed())).layout
    ...
    func threeFourAdjacentEighthsFormBeam() {
        ...
        let layout = NotationSnapshotTestSupport(timeSignature: .threeFour).legacyPrepare(notes: [
            Note(interval: .eighth, noteType: .snare, measureNumber: 1, measureOffset: 0),
