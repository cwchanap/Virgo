...
struct NotationLayoutEngineChordAndBeamTests {
    ...
    func beamsAreHorizontalAcrossDifferentPositions() throws {
        ...
        let layout = support.legacyPrepare(notes: notes).layout
    ...
    func widerRowWidthPacksMoreMeasuresPerRow() {
        ...
        let layout = support.legacyPrepare(notes: notes, style: wideStyle).layout
    ...
    func stemlessNoteInBeamRunDoesNotHijackEndpointX() throws {
        ...
        let layout = support.legacyPrepare(notes: notes, notePositionOverrides: [.hiHat: .line1]
            ).layout
    ...
    func unbeamedEighthNoteFlagAttachesAtStemTip() throws {
        ...
        let layout = support.legacyPrepare(notes: [note]).layout
    ...
    func unbeamedStemCoversTallSameVoiceChord() throws {
        ...
        let layout = support.legacyPrepare(notes: notes, notePositionOverrides: [.crash: .aboveLine9, .tom3: .belowLine6]
            ).layout
        let stem = try #require(layout.stems.first)
    ...
    func unbeamedLowerVoiceStemCoversTallChordFromLeft() throws {
        ...
        let layout = support.legacyPrepare(notes: notes, notePositionOverrides: [.kick: .aboveLine9, .hiHatPedal: .belowLine6]
            ).layout
        let stem = try #require(layout.stems.first)
    ...
    func stemlessBoundaryBreaksLayoutRun() throws {
        ...
        let layout = legacyPreparedNotation(GameplayNotationPreparationRequest(
            snapshot: snapshot,
