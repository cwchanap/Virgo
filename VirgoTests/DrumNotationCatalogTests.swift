    ...
    func approvedLegendIsExhaustive() throws {
        let expected = [
            ExpectedDefinition(
                ...
                voice: .lower, direction: .down, variant: .standard, order: 0
            ),
            ExpectedDefinition(
                noteType: .snare, drumType: .snare, position: .line3,
                voice: .upper, direction: .up, variant: .standard, order: 1
            ),
            ExpectedDefinition(
                noteType: .hiHat, drumType: .hiHat, position: .line5,
                voice: .upper, direction: .up, variant: .closedHiHat, order: 2
            ),
            ExpectedDefinition(
                noteType: .openHiHat, drumType: .hiHat, position: .line5,
                voice: .upper, direction: .up, variant: .openHiHat, order: 3
            ),
            ExpectedDefinition(
                noteType: .hiHatPedal, drumType: .hiHatPedal, position: .belowLine1,
                voice: .lower, direction: .down, variant: .pedalHiHat, order: 4
            ),
            ExpectedDefinition(
                noteType: .highTom, drumType: .tom1, position: .spaceBetween3And4,
                voice: .upper, direction: .up, variant: .highTom, order: 5
            ),
            ExpectedDefinition(
                noteType: .midTom, drumType: .tom2, position: .spaceBetween2And3,
                voice: .upper, direction: .up, variant: .midTom, order: 6
            ),
            ExpectedDefinition(
                noteType: .lowTom, drumType: .tom3, position: .line2,
                voice: .upper, direction: .up, variant: .floorTom, order: 7
            ),
            ExpectedDefinition(
                noteType: .crash, drumType: .crash, position: .aboveLine5,
                voice: .upper, direction: .up, variant: .crash, order: 8
            ),
            ExpectedDefinition(
                noteType: .ride, drumType: .ride, position: .spaceBetween4And5,
                voice: .upper, direction: .up, variant: .ride, order: 9
            ),
            ExpectedDefinition(
                noteType: .china, drumType: .crash, position: .aboveLine5,
                voice: .upper, direction: .up, variant: .china, order: 10
            ),
            ExpectedDefinition(
                noteType: .splash, drumType: .crash, position: .aboveLine5,
                voice: .upper, direction: .up, variant: .splash, order: 11
            ),
            ExpectedDefinition(
                noteType: .cowbell, drumType: .cowbell, position: .line4,
                voice: .upper, direction: .up, variant: .standard, order: 12
            )
        ]
