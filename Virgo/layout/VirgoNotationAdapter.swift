...
/// no view construction, no rendering, no mutation of layout outputs. Owns
/// the primitive/flag-paint mappers; the HPA-164 pre-format projection
/// (style mapping, snapshot→package input, visible-flag classification)
/// lives in ``VirgoNotationProjection``.
